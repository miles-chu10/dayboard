...
export function RemindersView() {
  ...
  const open =
    reminders.data?.state === "ok" ? reminders.data.items.filter((reminder) => !reminder.completed).length : null;
  ...
  return (
    <ScrollArea
      ...
      actions={<ViewActions onRefresh={() => void reminders.refetch()} refreshing={reminders.isFetching} />}
    >
