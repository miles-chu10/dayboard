// Small local copy of the atomic-write helpers used across main/services/file-store.ts, kept
// self-contained here so main/platform does not depend on files owned by another port agent.
