...
| AI and licensing                     | Stripe implemented and tested locally | 199 app tests; 16 billing tests including local Worker/D1/SDK integration; focused security findings closed |
